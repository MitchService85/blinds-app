...
export function BottomBar({ children, variant = "solid" }: BottomBarProps) {
  ...
  const className =
    variant === "solid"
      ? "safe-bottom sticky bottom-0 z-30 -mx-4 mt-auto flex flex-wrap gap-x-3 gap-y-1.5 border-t border-neutral-200 bg-white p-4 dark:border-neutral-800 dark:bg-neutral-950"
