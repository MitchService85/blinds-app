  ...
  return (
    <main className="mx-auto flex max-w-md flex-1 flex-col gap-4 p-4 pb-12">
      ...
      <Section title="Install mode" visual={<VisualInstall />}>
        ...
        <p><Icon name="circle-dot" size={14} className="text-emerald-600" /> <b>Staged</b> means the blinds and hardware are dropped off and ready — or your half of the work is done and it&apos;s ready for your partner. <Icon name="check-circle" size={14} className="text-emerald-600" /> means installed. <Icon name="lock" size={14} className="text-violet-600" /> <b>Locked out</b> means you couldn&apos;t get into the unit; it&apos;s the one thing a project manager with a share link can see, so they can arrange access. <Icon name="alert" size={14} className="text-amber-600" /> <b>Blocked</b> means something is stopping the install. Tapping <b>Blocked</b> opens the unit so you can say why: a note at the top for the whole unit, or <b>⚠</b> on the individual blinds that are wrong. <b>Unblock</b> is right there when it&apos;s sorted.</p>
